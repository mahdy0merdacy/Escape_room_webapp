...
const DEFAULT_FAQ: Omit<FaqItemRow, "id" | "createdAt" | "updatedAt">[] = [
  ...
  { order: 4, active: true, q_en: "Is it suitable for children?", q_fr: "Est-ce adapté aux enfants ?", q_ar: "هل هي مناسبة للأطفال؟", a_en: "We recommend a minimum age of 16 due to the intensity of some rooms, particularly Annabelle which contains strong horror elements. Children under 16 must be accompanied by a parent or guardian.", a_fr: "Nous recommandons un âge minimum de 16 ans en raison de l'intensité de certaines salles, notamment Annabelle qui contient de forts éléments d'horreur. Les moins de 16 ans doivent être accompagnés d'un parent ou tuteur.", a_ar: "نوصي بالحد الأدنى من العمر 16 عاماً نظراً لشدة بعض الغرف، خاصة أناهيلي التي تحتوي على عناصر رعب قوية. يجب أن يرافق الأطفال دون 16 عاماً أحد الوالدين أو وصياً." },
