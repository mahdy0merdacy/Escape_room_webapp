...
export default function FooterInner({ hours }: { hours: string }) {
  const t = useT();
    ...
    <footer className="bg-black border-t border-white/10 mt-auto">
      <div className="max-w-6xl mx-auto px-4 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          {/* Contact */}
          <div>
            <p className="text-white/70 text-xs font-semibold uppercase tracking-widest mb-4">{t.footer.contactHeading}</p>
